...
CREATE OR REPLACE VIEW `<PROJECT_ID>.rides_gold_views.vw_share_pickup_daily` AS
SELECT event_date, pickup_location, COUNT(*) AS rides,
...
GROUP BY event_date, pickup_location;
